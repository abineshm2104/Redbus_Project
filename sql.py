...
create_table_query = f"""create table bus_routes (id int primary key auto_increment ,route_name varchar(250),route_link varchar(250),busname varchar(250),bustype varchar(250),departing_time varchar(250),duration varchar(250),reaching_time time,start_rating float,price decimal,seats_available int);"""
...
table_insert_declaration = "(route_name ,route_link ,busname ,bustype ,departing_time ,duration ,reaching_time ,start_rating ,price,seats_available) values (%s, %s, %s,%s, %s, %s,%s, %s, %s,%s)"
